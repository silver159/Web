...
// 인수로 넘어온 form의 유효성을 검사를 하고 정상이면 true를 리턴하고 오류가 발생되면 오류 메시지를
// 출력하고 false를 리턴하는 함수
function formCheck(obj){
	...
	// console.log(Number(obj.j1.value)) // NaN 
	// => Number() 함수 사용시 true or false로 변환시켜야 한다.
	...
	// 같아야 한다.
	// 11로 나눈 나머지를 11에서 뺀 결과가 10 이상일 경우 10의 자리는 버리고 1의 자리만
