...
<!-- 
	현재 프로젝트는 session을 사용하지 않기 때문에 k20230626_1_register에서 사용하던 모든 
	스크립트릿을 삭제한다.  
-->
...
<div id="messageModal" class="modal fade" role="dialog" aria-hidden="true">
	<div class="vertical-alignment-helper">
		<div class="modal-dialog vertical-align-center">
			...
			<div id="messageCheck">
				<%-- <%=messageType.equals("성공 메시지")?"panel-success":"panel-warning"%> --%>
				<!-- 헤더 -->
...
<!-- 
모달 창을 띄우는 기능을 실행하는 스트립트를 ajax.js로 옴긴다.
