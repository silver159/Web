...
public class MemberVOEx {
	
	// 필드 선언
	// VO 클래스의 필드 이름은 VO 클래스에 저장될 데이터가 입력되는 form을 구성하는 요소들의
	// name 속성에 지정한 속성값과 데이터베이스 테이블을 구성하는 플드 이읆과 반드시 같은
	// 이름으로 만들어야 한다.
	...
	public MemberVOEx(String id, String name, String password, int age, boolean gender, String ip) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "MemberVOEx [id=" + id + ", name=" + name + ", password=" + password + ", age=" + age + ", gender="
				+ gender + ", ip=" + ip + "]";
	}
