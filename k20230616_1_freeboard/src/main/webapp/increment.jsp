...
// listView.jsp에서 넘어오는 조회수를 증가시킬 글번호와 메인글 확인 후 돌아갈 페이지 번호를
// 받는다.
...
//	response.sendRedirect("list.jsp?currentPage=" + currentPage); 테스트용
	response.sendRedirect("selectByIdx.jsp?idx="+ idx +"&currentPage=" + currentPage+"&job=contentView");
// forward로 보내면 increment부터 시작해서 새로고침시 계속 조회수가 증가된다.
