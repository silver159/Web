// Promise는 jacascript의 비동기 처리에 사용되는 객체이다.
...
// promise 만들기
// 새로운 promise가 생성되면 promise 객체를 만들 때 인수로 넘겨주는 executor 함수가 자동으로 
// 실행된다.
...
const promise = new Promise(function (resolve, reject) {
	...
	setTimeout(function () {
		// promise가 정상적으로 실행된 결과는 resolve() 함수가 인수로 리턴 시킨다.
		// resolve('홍길동'); // promise 성공
		// promise가 실패한 결과는 reject() 함수의 인수로 리턴 시킨다.
