...
// .filter(): 선택된 요소 중 전달 받은 선택자에 해당되거나, 함수 호출 결과가 참인 모든 요소를 
// 선택한다.
// .not(): 선택된 요소 중 전달 받은 선택자에 해당되거나, 함수 호출 결과가 거짓인 모든 요소를 
// 선택한다.
// .has(): 선택된 요소 중 전달 받은 선택자에 해당되는 요소의 모든 자손 요소를 선택한다.
// .is(): 선택된 요소 중 전달 받은 선택자에 해당되는 요소가 하나라도 존재하면 true를 리턴한다.
