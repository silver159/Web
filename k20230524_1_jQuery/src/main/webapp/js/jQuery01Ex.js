...
//  $(() => { // ().ready 생략, 화살표 함수, 가장 많이 사용됨!!!
//		alert('jQuery onload 이벤트6');
//  });	
// ===================================================

// $(() => alert('jQuery onload 이벤트7')); // 한줄인 경우
// ===================================================
...
// .eq(index): 선택된 요소 주 index 번째 요소를 선택한다. index는 0부터 시작한다.
// .slice(): 선택한 요소 중 전달받은 인덱스 범위에 해당하는 요소만 선택한다.
// .filter(): 선택된 요소 중 전달받은 선택자에 해당되거나, 함수 호출 결과가 참인 모든 요소를
// 선택한다.
// .not(): 선택된 요소 중 전달받은 선택자에 해당되거나, 함수 호출 결과가 거짓인 모든 요소를
// 선택한다.
...
function highLight() {
	...
	$('#list').css('background', 'hotpink'); // 단축 속성 스타일
	...
	$('#list > li').eq(1).css('backgroundColor', 'dodgerblue');
	$('#list > li').slice(2,5).css('backgroundColor', 'yellowgreen'); // 2,3,4
}
...
// hide(), show() 메소드의 인수로 시간(밀리초)을 설정하거나 "slow", "fast"와 같은 예약어를
// 전달해 속도를 설정할 수 있다.
...
// fadeIn(), fadeOut() 메소드의 인수로 시간(밀리초)을 설정하거나 "slow", "fast"와 같은 
// 예약어를 전달해 속도를 설정할 수 있다.
...
// slideUp(), slideDown() 메소드의 인수로 시간(밀리초)을 설정하거나 "slow", "fast"와 같은
// 예약어를 전달해 속도를 설정할 수 있다.
...
function hideImg() {
	...
	// jQuery
	// jacascript는 전체에 대해서 작업하려면 반복문을 사용해야 하지만 jQuery는 반복문을
	// 사용하지 않아도 된다. => 특별한 설정이 없으면 전체에 대해서 일괄 처리를 한다.
...
function showImg() {
	...
	// jQuery
	// javascript는 전체에 대해서 작업하려면 반복문을 사용해야 하지만 jQuery는 반복문을
	// 사용하지 않아도 된다. => 특별한 설정이 없으면 전체에 대해서 일괄 처리를 한다.
