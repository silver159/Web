...
<% 
// lib 폴더에 commonsDBCP 드라이버 클래스(commons-dbcp-1.4.jar,commons-pool-1.5.7.jar) 를
// 복사해 넣는다.
// src/main/java에 *.jocl 파일을 작성한다. => pool.jocl 파일을 복사해 넣는다.
// => 데이터베이스 연결 정보
...
// mysql 8.x
//	<object class="org.apache.commons.dbcp.DriverManagerConnectionFactory">
//		<string value="jdbc:mysql://localhost:3306/데이터베이스이름?severTimezone=UTC"/>
//		<string value="계정이름"/>
//		<string value="비밀번호"/>
//	</object>
...
//	</object>
	...
	try{
		...
		Class.forName("org.apache.commons.dbcp.PoolingDriver"); // commonsDBCP 드라이버
