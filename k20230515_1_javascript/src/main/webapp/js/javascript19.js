function openWin() {
	...
	let option = 'top=50px, left=100px, width=600px, height=600px'; // 윈도우 이름
...
function registerForm() {
	...
	// 로그인 버튼을 비활성화 시킨다.
	// 비활성화 할 버튼이 1개일 때
	// document.getElementsByName('btn')[1].disabled = 'disabled';  // 활성화시 ''입력
	
	// 비활성화 할 버튼이 여러개일 때
	// name 속성인 btn인 모든 버튼 객체를 얻어온다.
	/*
...
function closeWin() {
	...
	// registerForm() 함수에서 비활성화한 input 태그를 활성화 시킨다.
	let inputs = document.getElementsByTagName('input');
