function tableAdd() {
	...
	// forms: 형재 문서의 form을 배열 형태로 저장하고 있는 자바스크립트 내장객체
	let form = document.forms[0];
	// console.log(form);
	
	// 폼객체가저장된변수(form).name속성값.value: form에서 지정된 name 속성을 가지는 요소의 입력된
	// 값을 얻어올 수 있다.
	...
	// <tbody> 태그를 얻어온다.
	let tbody = document.getElementById('addrt')
	
	// 배열에 저장된 데이터를 사용해서 <tbody> 태그레 추가할 행(<tr> 태그)을 만드는 함수를
