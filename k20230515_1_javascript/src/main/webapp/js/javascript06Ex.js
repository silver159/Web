...
// 객체의 멤버로 함수를 가질 수 있다.
	...
	say: function say(){
		...
		// 함수에서 정의한 함수에서 객체의 멤버를 참조할 때는 자신을 의미하는 'this'를 붙여야
		// 한다.
		// 'this'가 있을 때는 화살표 함수로 변환할 수 없다.
...
cat.say2 = dog.say; // dog 객체의 say() 함수를 cat 객체에 주입합ㄴ다.
console.log(cat);
cat.say2(); // 야옹
console.log('=============================================');
...
// getter: get으로 선언하는 함수
	get sum() {
		// getter는 특정 멤버의 값이나 연산 결과를 얻어와야 하므로 일반적으로 값을 
		// return 시켜야 한다.
		// 값을 리턴 시키지 않으면 undefined가 리턴된다.
