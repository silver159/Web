...
<%@page import="com.tjoeun.memoList.DBUtilEx"%>
...
<% 
	//한글 깨짐을 방지하고 memoList.jsp 넘어오는 데이터를 받는다.
	...
	// 데이터베이스에 접속한다.
	Connection conn = DBUtilEx.getMysqlConnectionEx();
	/*
	...
	*/
	...
	// 테이블에 저장된 데이터를 브라우저에 출력하기 위해 memoListEx.jsp로 넘겨준다.
	response.sendRedirect("memoListEx.jsp");
%>
